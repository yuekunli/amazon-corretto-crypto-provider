...
public class SHA256Test {
  ...
  public void testNullDigest() throws Exception {
    ...
    assertArrayEquals(
        Hex.decodeHex(
            "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855".toCharArray()),
        digest.digest());
    digest = getDigest();
  ...
  public void testVector() throws Exception {
    ...
    assertArrayEquals(
        Hex.decodeHex(
            "cf80cd8aed482d5d1527d7dc72fceff84e6326592848447d2dc0b0e87dfc9a90".toCharArray()),
        digest.digest());
  }
  ...
  public void cavpShortVectors() throws Throwable {
    try (final InputStream is =
        new GZIPInputStream(TestUtil.getTestData("SHA256ShortMsg.rsp.gz"))) {
