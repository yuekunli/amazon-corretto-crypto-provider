...
public class NativeTestHooks {
  ...
  public static native void getBytesLocked(
      byte[] array, int offset, int length, int off2, int len2);

  public static native void putBytesLocked(
      byte[] array, int offset, int length, int off2, int len2);

  public static native void borrowCheckRange(
      byte[] array, int offset, int length, int off2, int len2);
  ...
  public static class RequireHooks implements ExecutionCondition {
    private static final ConditionEvaluationResult ENABLED =
        ConditionEvaluationResult.enabled("Hooks present");
    private static final ConditionEvaluationResult DISABLED =
        ConditionEvaluationResult.disabled("Hooks missing");
