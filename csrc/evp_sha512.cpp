...
)
{
	try
	{
		...
		EVP_MD* md = EVP_MD_fetch(NULL/*lib ctx*/, OSSL_DIGEST_NAME_SHA2_512, NULL/*prop queue*/);
		EVP_DigestInit(ctx, md);
	}
	catch (java_ex& ex)
	{
...
JNIEXPORT void JNICALL Java_com_amazon_corretto_crypto_provider_SHA512Spi_resetContext(
	JNIEnv* pEnv,
	jclass,
	jlong ctxPtr)
{
...
JNIEXPORT void JNICALL Java_com_amazon_corretto_crypto_provider_SHA512Spi_cloneContext(
	JNIEnv* pEnv,
	jclass,
	jlong ctxPtr,
	jlongArray ctxOut)
