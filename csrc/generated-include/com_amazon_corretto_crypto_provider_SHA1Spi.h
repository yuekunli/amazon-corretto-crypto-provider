 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_amazon_corretto_crypto_provider_SHA1Spi_getHashSize
  (JNIEnv *, jclass);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_amazon_corretto_crypto_provider_SHA1Spi_getContextSize
  (JNIEnv *, jclass);
